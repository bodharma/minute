...
public enum RecordingGuardNotification {
    ...
    public static let continueActionIdentifier = "minute.recording-guard.continue"
...
public extension Notification.Name {
    ...
    static let minuteRecordingGuardContinueRecording = Notification.Name("minute.recording-guard.continue-recording")
}
